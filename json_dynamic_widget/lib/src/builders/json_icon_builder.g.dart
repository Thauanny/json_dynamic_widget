...
part of 'json_icon_builder.dart';
...
class JsonIconBuilder extends _JsonIconBuilder {
  const JsonIconBuilder({required super.args});

  static const kType = 'icon';
  ...
  @override
  JsonIconBuilderModel createModel({
    ChildWidgetBuilder? childBuilder,
    required JsonWidgetData data,
  }) {
    final model = JsonIconBuilderModel.fromDynamic(
      args,
...
class JsonIcon extends JsonWidgetData {
  JsonIcon(
    this.icon, {
...
/// Creates an icon.
class JsonIconBuilderModel extends JsonWidgetBuilderModel {
  const JsonIconBuilderModel(
    super.args, {
    this.applyTextScaling,
    this.color,
    this.fill,
  ...
  static JsonIconBuilderModel fromDynamic(
    dynamic map, {
    Map<String, dynamic> args = const {},
    JsonWidgetRegistry? registry,
  }) {
    ...
    if (result == null) {
      throw Exception(
        '[JsonIconBuilder]: requested to parse from dynamic, but the input is null.',
      );
    }
  ...
  static JsonIconBuilderModel? maybeFromDynamic(
    dynamic map, {
    Map<String, dynamic> args = const {},
    JsonWidgetRegistry? registry,
  }) {
    JsonIconBuilderModel? result;
    ...
    if (map != null) {
      ...
      if (map is JsonIconBuilderModel) {
        result = map;
      } else {
        registry ??= JsonWidgetRegistry.instance;
        map = registry.processArgs(map, <String>{}).value;
        result = JsonIconBuilderModel(
          args,
