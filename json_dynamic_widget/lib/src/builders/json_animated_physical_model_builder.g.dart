...
class JsonAnimatedPhysicalModel extends JsonWidgetData {
  JsonAnimatedPhysicalModel({
    ...
    required this.child,
          ...
          jsonWidgetBuilder: () => JsonAnimatedPhysicalModelBuilder(
    ...
    if (map != null) {
      ...
      if (map is JsonAnimatedPhysicalModelBuilderModel) {
        ...
        result = JsonAnimatedPhysicalModelBuilderModel(
          ...
          elevation: () {
            dynamic parsed = JsonClass.parseDouble(map['elevation']);

            if (parsed == null) {
              throw Exception(
                'Null value encountered for required parameter: [elevation].',
              );
            }
            return parsed;
          }(),
          ...
          shape: () {
            ...
            if (parsed == null) {
              throw Exception(
                'Null value encountered for required parameter: [shape].',
              );
            }
            return parsed;
          }(),
